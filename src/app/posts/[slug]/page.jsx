...
export default async function Post({ params }) {
  ...
  return (
    <article>
      ...
      <img style={{width: '100%'}} src={post.coverImage.url}  alt={'Cover image'} width={post.coverImage.width} height={post.coverImage.height}/>
      <div
        className="divide-y lg:divide-y-0 divide-gray-200 lg:grid lg:grid-cols-[200px_1fr] gap-x-6 pb-16 lg:pb-20"
        style={{ gridTemplateRows: 'auto 1fr', marginTop: '16px' }}
      >
        <dl className="pt-6 pb-10 lg:pt-0 lg:border-b lg:border-gray-200">
         { post.author && (<>
          <dt className="mb-2 text-sm font-medium leading-5">Napisane przez</dt>
          <dd>
          ...
          <div className="mt-8">
            <dt className="text-sm font-medium leading-5">Opublikowano</dt>
